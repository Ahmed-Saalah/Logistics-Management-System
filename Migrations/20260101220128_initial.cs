        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipemntId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_AspNetUsers_UserrId",
                        column: x => x.UserrId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipperCountry = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ShipperCity = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ...
                    ReceiverCountry = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
